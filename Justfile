...
ssh-update-config:
    ssh -t pihole "zsh -ci \"cd .dotfiles && sudo pihole-FTL --teleporter && just prune-teleporter && config add . && config pull && configpush 'Update pihole config in dotfiles repo'\""
